...
class Movie:
    ...
    def rent (self) -> bool:
        ...
        if self.movie_id  is self.is_rented:
            ...
            raise Exception ("Il film '{self.title}' è già noleggiato.")
...
class VideoRentalStore:
    ...
    def add_movie(self, movie_id: str, title: str, director: str): 
        ...
        if movie_id in self.movies:
            ...
            new_movie = Movie(movie_id, title, director, False)
    ...
    def rent_movie(self, customer_id: str, movie_id: str): 
        ...
        if customer_id and movie_id in self.customers and self.movies:
